...
async def start(client, message):
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(f"<b>🚫 𝐓𝐡𝐢𝐬 𝐌𝐨𝐯𝐢𝐞 𝐖𝐢𝐥𝐥 𝐁𝐞 𝐆𝐨𝐢𝐧𝐠 𝐓𝐨 𝐃𝐞𝐥𝐞𝐭𝐞𝐝 𝐈𝐧 <code>{get_time(DELETE_TIME)}</code> 𝐓𝐨 𝐀𝐯𝐨𝐢𝐝 𝐂𝐨𝐩𝐲𝐫𝐢𝐠𝐡𝐭 ©️\n\n🗳 𝐒𝐨 𝐏𝐥𝐞𝐚𝐬𝐞 𝐅𝐨𝐫𝐰𝐚𝐫𝐝 𝐘𝐨𝐮𝐫 𝐌𝐨𝐯𝐢𝐞 𝐓𝐨 𝐒𝐚𝐯𝐞 𝐌𝐞𝐬𝐬𝐚𝐠𝐞.</b>", quote=True)
            await asyncio.sleep(DELETE_TIME)
            await msg.delete()
    ...
    k = await msg.reply(f"<b><b>🚫 𝐓𝐡𝐢𝐬 𝐌𝐨𝐯𝐢𝐞 𝐖𝐢𝐥𝐥 𝐁𝐞 𝐆𝐨𝐢𝐧𝐠 𝐓𝐨 𝐃𝐞𝐥𝐞𝐭𝐞𝐝 𝐈𝐧 <code>{get_time(DELETE_TIME)}</code> 𝐓𝐨 𝐀𝐯𝐨𝐢𝐝 𝐂𝐨𝐩𝐲𝐫𝐢𝐠𝐡𝐭 ©️\n\n🗳 𝐒𝐨 𝐏𝐥𝐞𝐚𝐬𝐞 𝐅𝐨𝐫𝐰𝐚𝐫𝐝 𝐘𝐨𝐮𝐫 𝐌𝐨𝐯𝐢𝐞 𝐓𝐨 𝐒𝐚𝐯𝐞 𝐌𝐞𝐬𝐬𝐚𝐠𝐞.</b></b>", quote=True)     
    await asyncio.sleep(DELETE_TIME)
    await msg.delete()
    await k.edit_text("<b>ʏᴏᴜʀ ᴠɪᴅᴇᴏ / ꜰɪʟᴇ ɪꜱ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ !!</b>")
    return
